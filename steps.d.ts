...
declare namespace CodeceptJS {
  export interface I {
    ...
    connect(key: string, conn: string, driver: string) : void,
    disconnect(key: string) : void,
    removeConnection(key: string) : void,
    query(key: string, command: string, params: string) : void,
    run(key: string, command: string, params: string) : void,
    createConnection(conn: string, driver: string) : void,
    hasConnection(key: string) : void,
    getConnection(key: string) : void,
    seeTitle() : void,
    printTxt(text: string) : void,
    say(msg: string) : void,
